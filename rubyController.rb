...
def best_Elevator(optionA ,optionB ,requested ,status ,directionA ,directionB)
    ...
    directionB
            ...
            if status == 'none' and requested == optionA
            ...
            elsif (status == 'up' or status == 'down') and directionA == 'idle' and optionA < 5 and 5 > requested and optionA < requested
                ...
                elsif (status == 'up' or status == 'down') and directionB == 'idle' and optionB < 5 and requested < 5 and optionB > requested
                ...
                elsif(status == 'up' or status == 'down') and  directionA=='idle'  and optionA < 5 and requested < 5  and  optionA < requested
                puts "Elevator A is comming 3\n"
                loop do
                    puts optionA
                    optionA +=1
                    if optionA == requested+1
                 ...
                 puts "Elvator B is comming 4\n"
                 elsif(status == 'up' or status == 'down') and directionA == 'idle' and optionA < 5 and requested < 5 and optionA > requested
                 puts "Elevator A is comming 5\n"
                 elsif(status == 'up' or status == 'down') and  directionA=='idle' and optionA > 5 and requested > 5  and  optionA > requested
                 ...
                 puts "open door"
                 elsif(status == 'up' or status    == 'down' ) and directionB == 'moving' and (optionB < 10 or optionB > 0)
                 puts "Elevator A is comming 7\n"
                 ...
                 print("Elevator B is comming to 10\n")
                 loop do
                    puts optionB
                    optionB -=1
                    if optionB == requested-1
